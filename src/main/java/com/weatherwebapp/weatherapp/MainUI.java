...
public class MainUI extends UI {
    ...
    private void addForm() {
        ...
        Button AddingButton = new Button("Akhisar'ın Hava Durumunu Göster");
        ...
        AddingButton.addClickListener(click ->{
            ...
            WeatherE weather = weatherService.getWeather("Turkey", "Akhisar");
    ...
    private void addHeader() {
        Label header = new Label("Akhisar Hava Durumu");
